...
class TwitterClient(object):
    ...
    def userTimeline(self, username, count = 100):
    ...
    def __timeline(self, resource, parameters, count):
        ...
        maximum_duration_between_retrievals = TWITTER_RATE_LIMIT_WINDOW \
            / rate_limit
...
class Tweet(object):
    def __init__(self, raw_data):
        ...
        if "retweeted_status" in self.raw_data:
            process(self.raw_data["retweeted_status"])
            self.retweet = True
